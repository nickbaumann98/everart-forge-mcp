...
async function saveImage(imageUrl: string, prompt: string, model: string, format: string = "svg", outputPath?: string): Promise<string> {
  let filepath: string;
  ...
  tools: [
    {
      name: "generate_image",
      description:
        "Generate images using EverArt Models, saves locally and returns file path. " +
        "Available models:\n" +
